...
- **More Content**: Integrates with Jellyseerr's [https://docs.seerr.dev/using-jellyseerr/settings/services](existing services) when you mark movies or series as favorites in Jellyfin
