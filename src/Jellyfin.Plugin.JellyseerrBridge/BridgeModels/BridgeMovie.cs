...
/// <summary>
/// Bridge Jellyseerr movie model with bridge functionality.
/// </summary>
public class BridgeMovie : MovieResult, IEquatable<BridgeMovie>, IEquatable<BaseItem>
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the genres for this movie.
    /// </summary>
    ...
    public bool Equals(BridgeMovie? other)
    {
    ...
    public bool Equals(BaseItem? other)
    {
        ...
        return Id == movie.GetProviderId(MetadataProvider.Tmdb);
    }
    ...
    public override bool Equals(object? obj)
    {
        return obj switch
        {
            BridgeMovie movie => Equals(movie),
